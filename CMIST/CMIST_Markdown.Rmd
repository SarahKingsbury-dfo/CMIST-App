...
Pre_Assessment_info<- renderTable(req(prep()))

print(Pre_Assessment_info)
```
...
Risk_Score<-renderTable({CMISTScore(req(risks()), req(uncertainties()))})
    
tab<-renderTable(req(risks()), req(uncertainties()), req(rationale()))
...
Reference_List<-renderTable(req(REFList()))

paste0(Reference_List)
