...
uncertainties<-eventReactive(input$go,{c(U1= input$U1,
 ...
 DT::renderDataTable({
    rbind(risks=req(risks()),uncertainties=req(uncertainties()), rationale=req(rationale()))%>%
...
if(!file.exists("cmist_data.csv")){
  download.file(file.path("https://www.bio.gc.ca/science/monitoring-monitorage/cmist/data-donnees-en.php?ASM_YEAR=-1&PRJ_ID=-1&COU_ID_1=-1&RG_ID=-1&ASA_STUDY_AREA=-1&MWT_ID=-1&BOW_ID=-1&ASA_SOUTHERN_LATITUDE=&ASA_NORTHERN_LATITUDE=&ASA_WESTERN_LONGITUDE=&ASA_EASTERN_LONGITUDE=&SPC_GENUS-SPC_SPECIES=-1&TAX_ID=-1&ASU_ADJ_RISK_SCORE=#results", "cmist_data.csv"))
}
